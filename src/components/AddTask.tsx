        ...
        <div className="w-full mt-4">
            <form>
                <div className="mb-4 flex flex-col gap-2 ">
                    ...
                    <input type="text" name="task" id="task" className="bg-gray-500 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-400 dark:border-gray-400 dark:placeholder-gray-500 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="What do you want to do?" required />
                </div>
                <div>
